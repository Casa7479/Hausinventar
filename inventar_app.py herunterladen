...
with st.form("add_item"):
    ...
    with col2:
        cabinet = st.text_input("🗄️ Schrank / Regal", placeholder="z. B. Regal A")
    with col3:
    ...
    submitted = st.form_submit_button("✔️ Speichern")
...
if st.session_state.inventory:
    if st.button("⬇️ CSV-Export"):
        ...
        st.download_button("📥 Download CSV", data=df.to_csv(index=False), file_name="inventar.csv", mime="text/csv")
